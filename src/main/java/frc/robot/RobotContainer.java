...
shooter.setDefaultCommand(shooter.setDutyCycle(0));
    ...
    //   driverXbox.b().onTrue(arm.setAngle(Degrees.of(40)));
    //   driverXbox.a().onTrue(arm.setAngle(Degrees.of(10)));
      driverXbox.x().onTrue(shooter.setVelocity(AngularVelocity.ofBaseUnits(20, RPM)));
      driverXbox.y().onTrue(shooter.shooterFeedForwardsFromElastic());
